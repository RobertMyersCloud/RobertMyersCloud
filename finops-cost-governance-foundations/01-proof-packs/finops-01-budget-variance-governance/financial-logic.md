...
- Allocation changes materially shift costs between owners/cost centers.

**Output expectation:**
- Forecast note containing business rationale + date + owner (traceable in the evidence index).
...
3. **Subscription default mapping:** Subscription-to-owner/cost center mapping.
4. **Unallocated bucket:** Any remainder assigned to a shared/central bucket for follow-up.
...
**Output expectation:**
- Allocation exception list (count, $ amount, owners impacted) recorded in the evidence index.
