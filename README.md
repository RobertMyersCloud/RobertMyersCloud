...
|---|---|
| [**iam-proof-portfolio**](https://github.com/RobertMyersCloud/iam-proof-portfolio) | Identity governance proof packs (JML lifecycle, RBAC, MFA, lifecycle controls) with policy, evidence, and control mapping |
| [**entra-privileged-access-pack**](https://github.com/RobertMyersCloud/entra-privileged-access-pack) | Privileged Identity Management (PIM), just-in-time access, and break-glass governance |
| [**conditional-access-zero-trust-pack**](https://github.com/RobertMyersCloud/conditional-access-zero-trust-pack) | MFA enforcement, device-based access control, and Zero Trust policy design |
| [**access-review-program-pack**](https://github.com/RobertMyersCloud/access-review-program-pack) | Access certification workflows, reviewer accountability, and audit evidence |
| [**iam-automation-scripts**](https://github.com/RobertMyersCloud/iam-automation-scripts) | PowerShell and Terraform automation for identity provisioning and governance |
| [**cmmc-identity-control-mappings**](https://github.com/RobertMyersCloud/cmmc-identity-control-mappings) | IAM controls mapped to NIST 800-171 / CMMC Level 2 |
...
**Security:** Microsoft Sentinel · KQL

**Compliance:** NIST 800-53 · NIST 800-171 · CMMC Level 2 · DFARS

**FinOps:** Identity-based cost attribution · License optimization

<br>

## Credentials

**Active:** CMMC RP · FinOps CP · CCZT · Security+ · Network+ · ISC2 CC · SailPoint ISL · AZ-900 · SC-900 · AWS CCP · ITIL 4 · LSS Green Belt
