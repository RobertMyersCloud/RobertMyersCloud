...
If you only have 10 minutes, review in this order:

1. **Portfolio map:** **[PORTFOLIO.md](PORTFOLIO.md)**
2. **Primary proof pack:** **[Proof Pack 01 README](01-proof-packs/finops-01-budget-variance-governance/README.md)**
3. **Executive lens:** [Executive summary](01-proof-packs/finops-01-budget-variance-governance/executive-summary.md)
4. **Decision logic (“engine”):** [Financial logic](01-proof-packs/finops-01-budget-variance-governance/financial-logic.md)
5. **Traceability:** [Evidence index](01-proof-packs/finops-01-budget-variance-governance/evidence/evidence-index.md)

---

## Foundational context (repo standards)
These documents define how the repo is structured and how governance decisions are evaluated.

- **[How to review this repository](00-context/how-to-review.md)**
- **[Operating principles](00-context/operating-principles.md)**
- **[FinOps maturity positioning](00-context/maturity-positioning.md)**
- **[Data sources (conceptual)](00-context/data-sources.md)**
...
- **[Proof Pack 01 — Budget vs Actuals & Variance Governance](01-proof-packs/finops-01-budget-variance-governance/README.md)**
  ...
  - [Sample variance table](01-proof-packs/finops-01-budget-variance-governance/evidence/tables/sample-variance-table.md)
